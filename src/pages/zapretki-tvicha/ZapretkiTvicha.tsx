            ...
            },
            {
                ...
                "mainEntity": [
                    ...
                    },
                    {
                        ...
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "Да, через Twitch Appeal Form. Рассмотрение занимает от нескольких дней до нескольких недель. Успех зависит от тяжести нарушения и истории аккаунта."
                        }
                    },
                    {
                        "@type": "Question",
            ...
            <article className={styles.article}>
                ...
                <nav className={styles.toc}>
                    ...
                    <ol className={styles.toc_list}>
                        ...
                        <li><a href="#sanctions">Санкции: от таймаута до permanent ban</a></li>
                ...
                <section id="what">
                    ...
                    <p>
                        ...
                        &laquo;запретка&raquo; прижился в&nbsp;русскоязычном стримерском сообществе примерно с&nbsp;2020
                        года, когда Twitch начал массово ужесточать модерацию русскоязычного контента.
                    </p>
                    <p>
                        До&nbsp;2019 года модерация Twitch была сфокусирована на&nbsp;англоязычном контенте.
                    ...
                    <p>
                        Twitch формулирует правила размыто: &laquo;высказывания ненависти на&nbsp;основе расы,
                        этнической принадлежности, пола, гендерной идентичности, сексуальной ориентации,
                        инвалидности или иммиграционного статуса&raquo;. На&nbsp;практике это означает сотни
                        конкретных слов и&nbsp;выражений на&nbsp;десятках языков.
                    </p>
                </section>
                ...
                <section id="categories">
                    ...
                    <div className={styles.category}>
                        ...
                        <div className={styles.severity_badge} data-level="medium">Timeout 10 мин &rarr; ban 24ч</div>
                        <p>
                    ...
                    <div className={styles.category}>
                        ...
                        <p>
                            ...
                            Twitch начал активно модерировать с&nbsp;2022 года. Использование медицинских
                ...
                <section id="how-twitch-finds">
                    ...
                    <div className={styles.method_card}>
                        <h3 className={styles.h3}>AutoMod&nbsp;&mdash; автоматическая модерация</h3>
                        <p>
                            Встроенная система Twitch анализирует чат и&nbsp;речь стримера в&nbsp;реальном
                            времени. AutoMod использует машинное обучение для&nbsp;распознавания оскорблений
                            на&nbsp;десятках языков, включая русский. Система постоянно обучается и&nbsp;с&nbsp;каждым
                            годом распознаёт всё больше вариаций запреток.
                        </p>
                    </div>
                ...
                <section id="sanctions">
                    <h2 className={styles.h2}>Санкции: от&nbsp;таймаута до&nbsp;permanent ban</h2>
                    <p>
                        Twitch применяет прогрессивную систему наказаний. Тяжесть санкции зависит
                        от&nbsp;категории нарушения, истории аккаунта и&nbsp;контекста.
                    </p>

                    <div className={styles.sanction_timeline}>
                        <div className={styles.sanction_step} data-level="low">
                            <h3 className={styles.h3}>Timeout</h3>
                            <p className={styles.sanction_duration}>10 мин / 1 час / 24 часа</p>
                            <p>
                                Самая лёгкая санкция. Применяется за&nbsp;первичные нарушения с&nbsp;матом
                                или незначительными оскорблениями. Стример может продолжать стрим, но
                        ...
                        <div className={styles.sanction_step} data-level="medium">
                            ...
                            <p className={styles.sanction_duration}>3 дня / 7 дней / 30 дней</p>
                            <p>
                                Канал полностью блокируется на&nbsp;указанный срок. Стример теряет доход,
                                подписчиков и&nbsp;позиции в&nbsp;рекомендациях. Применяется за&nbsp;банворды
                                из&nbsp;категорий hate speech, повторные нарушения с&nbsp;матом.
                            </p>
                        </div>
                    ...
                    <div className={styles.appeal_block}>
                        ...
                        <p>
                            Twitch позволяет подать апелляцию через специальную форму. Рассмотрение
                            занимает от&nbsp;нескольких дней до&nbsp;нескольких недель. Шансы на&nbsp;успех
                            зависят от&nbsp;тяжести нарушения: timeout за&nbsp;мат оспорить реально,
                            permanent ban за&nbsp;расовое оскорбление&nbsp;&mdash; практически невозможно.
                            Лучшая стратегия&nbsp;&mdash; не&nbsp;допускать бана.
                        </p>
                    </div>
                </section>
                ...
                <section id="faq">
                    ...
                    <details className={styles.faq_item} onClick={onFaqToggle}>
                        ...
                        <p className={styles.faq_answer}>
                            Да, через Twitch Appeal Form. Рассмотрение занимает от&nbsp;нескольких дней
                            до&nbsp;нескольких недель. Шансы зависят от&nbsp;тяжести: timeout оспорить
                            реально, permanent за&nbsp;hate speech&nbsp;&mdash; практически невозможно.
                        </p>
                    </details>
