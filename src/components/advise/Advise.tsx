                ...
                <div className={styles.container_inner}>
                    ...
                    <div className={styles.cards}>
                        <div className={styles.card} data-variant={'red'}>
                            <h3 className={styles.card_title}>Проблема</h3>
                            <p className={styles.card_description}>Одна случайная запретка в&nbsp;прямом эфире стоит вам
                                монетизации, партнёрств и&nbsp;репутации. Ловить каждое слово невозможно,
                                а&nbsp;стримкилеры постоянно норовят вас уловить.</p>
                            <img className={styles.card_image} src={card1} alt="Проблема — запретка в стриме" loading="lazy" />
                        ...
                        <div className={styles.card} data-variant={'green'}>
                            <h3 className={styles.card_title}>Решение</h3>
                            <p className={styles.card_description}>
                                <strong>SpeechShield </strong>
                                SpeechShield автоматически обнаруживает и&nbsp;заглушает ненормативную лексику
                                в&nbsp;реальном времени. Стримьте спокойно&nbsp;&mdash; программа спасёт вас
                                от&nbsp;запреток.</p>
                            <img className={styles.card_image} src={card2} alt="Решение — SpeechShield защищает стрим" loading="lazy" />
